...
public class CuerpoTecnico extends Persona implements Serializable {
    ...
    public CuerpoTecnico(EntityManager entityManager, Long dni, String apellido, String nombre, Localidad unaLocalidad, String domicilio, Date fechaNacimiento, Date fechaIngreso, boolean activo, String email, String telFijo, String telCelular) {
