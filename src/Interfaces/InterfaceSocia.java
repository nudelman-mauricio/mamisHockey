 ...
 * @author Lucas
 */
public class InterfaceSociaa extends javax.swing.JFrame {

    /**
     * Creates new form InterfaceSociaa
     */
    public InterfaceSociaa() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceSociaa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceSociaa().setVisible(true);
            }
        });
    }
